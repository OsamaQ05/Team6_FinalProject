...
{
    public class EgyptSequentialObjective : MonoBehaviour
    {
        // Event that fires when objective changes
        public event Action<int> OnObjectiveChanged;
        ...
        private EgyptActiveObjective currentActiveObjective;
        ...
        public void AdvanceToNextObjective()
        {
            ...
            if (currentObjectiveIndex < ObjectiveSteps.Count)
            {
                ...
                // Fire event to notify listeners of objective change
                OnObjectiveChanged?.Invoke(currentObjectiveIndex);
            }
            else
            {
                ...
                // Fire event with index beyond list to indicate completion
                OnObjectiveChanged?.Invoke(currentObjectiveIndex);
            }
        }
        ...
        private void CreateNextObjective()
        {
            ...
            currentActiveObjective = gameObject.AddComponent<EgyptActiveObjective>();
    ...
    public class EgyptActiveObjective : Objective
    {
