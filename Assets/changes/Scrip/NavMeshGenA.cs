...
[RequireComponent(typeof(Unity.AI.Navigation.NavMeshSurface))]
public class NavMeshGenA : MonoBehaviour
{
    ...
    // Replace Odin [Button] with a custom editor menu item
    [MenuItem("NavMesh/Generate NavAreas")]
    static void BuildStatic()
    {
        NavMeshGenA navMeshGen = Selection.activeGameObject?.GetComponent<NavMeshGenA>();
        if (navMeshGen != null)
        {
            navMeshGen.Build();
        }
        ...
        {
            Debug.LogError("No NavMeshGenA component found on selected object");
        }
    }

    // Added public access for the menu item
    public void Build()
    {
               ...
               // try
                {
                    ...
                    //obj.isStatic = true;
                    Unity.AI.Navigation.NavMeshModifierVolume nmmv = obj.AddComponent<Unity.AI.Navigation.NavMeshModifierVolume>();
...
escape:
        ...
        foreach (Unity.AI.Navigation.NavMeshSurface nsurface in GetComponents<Unity.AI.Navigation.NavMeshSurface>())
        {
