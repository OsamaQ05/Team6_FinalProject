...
namespace Unity.FPS.Game
{
    public class GameFlowManager : MonoBehaviour
    {
        ...
        public string LoseGameMessage;

        [Tooltip("Duration of delay before the lose message")]
        public float DelayBeforeLoseMessage = 1f;

        [Tooltip("Time before scene restarts after losing")]
        public float RestartSceneDelay = 4f;
       ...
       void EndGame(bool win)
{
    ...
    else
    {
        ...
        // 👇 Restart current scene instead of loading a separate lose scene
        m_SceneToLoad = SceneManager.GetActiveScene().name;
        m_TimeLoadEndGameScene = Time.time + RestartSceneDelay;
    }
}
